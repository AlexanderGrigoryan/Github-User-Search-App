...
function Header({ changeMode, setChangeMode }) {
    ...
    <div className={styles.header__container}>
      <p
        className={`${styles.header__logo} ${
          changeMode ? styles.logo__dark : null
        }`}
      >
        devfinder
      </p>
      <div
        className={`${
          changeMode ? styles.header__button : styles.header__button_dark
        }`}
      >
        <p
          className={`${styles.button__text} ${
            changeMode ? styles.text__dark : null
          }`}
        >
        ...
        <button
          ...
          className={`${styles.header__btn} ${
            changeMode ? styles.header__dark : null
          }`}
        >
          {changeMode ? (
            <svg
              className={styles.header__sun}
              width="20"
              height="20"
